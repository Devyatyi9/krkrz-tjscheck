...
// Based on official string_table_en.rc from krkrz source
...
TJS_MSG_DECL(TJSObjectWasNotFreed, TJS_W("Object %1 [%2] was not freed / The object was created at : %3"))
...
TJS_MSG_DECL(TJSWarnRunningCodeOnDeletingObject, TJS_W("Running code on deleting-in-progress object"))
...
TJS_MSG_DECL(TJSNotSupportedUnpackLP, TJS_W("Not supported unpack 'p'"))
